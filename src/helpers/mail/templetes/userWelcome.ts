const userWelcome = (employeeId: string, email: string, password: string) => {
  return `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
    ...
    <table bgcolor="#fff" cellpadding="0" cellspacing="0" class="" style="margin: 0 auto; width: 100%; margin-top: 10px;">
    <tbody style="margin-top: 15px;">
      <tr class="">
    <td class="">
    <img alt="robot picture" class="" height="50" src="https://indiano.travel/wp-content/uploads/2022/02/Untitled-1300-x-346-px.png" width="155">
    </td>
    </tr>
    <tr class=""><td class="headline">Welcome to Indiano Travel!</td></tr>
    <tr>
    <td>
    <center class=""><table cellpadding="0" cellspacing="0" class="" style="margin: 0 auto;" width="75%"><tbody class=""><tr class="">
    <td class="" style="color:#444; font-weight: 400;"><br><br>
    Welcome to Indano Travel! We are excited to have you as a part of our platform. If you have any questions or need assistance, feel free to reach out to us. <br><br>
    
     <br>
      Your login credentials are provided below:
    <br>
    <span style="font-weight:bold;">Employee ID: &nbsp;</span><span style="font-weight:lighter;" class="">${employeeId}</span> 
     <br>
    ...
    <td class="">
    <div class="">
    <a style="background-color:#5252E7;border-radius:4px;color:#fff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:50px;text-align:center;text-decoration:none;width:350px;-webkit-text-size-adjust:none;" href="https://indiano.travel">Visit Account and Start Managing</a>
    </div>
     <br>
    </td>
    </tr>
